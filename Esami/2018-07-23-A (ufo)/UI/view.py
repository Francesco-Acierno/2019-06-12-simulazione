...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._btnSelezionaAnno = ft.ElevatedButton(text="Seleziona anno",
                                                   on_click=self._controller.handleSelezionaAnno)
        row1 = ft.Row([
            ft.Container(self._txtAnno, width=300),
            ft.Container(self._btnSelezionaAnno, width=300)
        ], alignment=ft.MainAxisAlignment.CENTER)
        self._page.controls.append(row1)

        # ROW2
        self._ddForma = ft.Dropdown(label="Forma")
        self._btnCreaGrafo = ft.ElevatedButton(text="Crea grafo",
                                               on_click=self._controller.handleCreaGrafo)

        row2 = ft.Row([
            ft.Container(self._ddForma, width=300),
